...
"""
    ...
    "elf": {
        "name": "Elfo",
        "title": "🧝 Elfos 🧝",
        "image": "URL_IMAGEN_ELFO",
        "confirm_text": "Soy Elfo",
        "confirm_callback": "confirm_race_elf",
        "description": """
╔══════════════════════════════════════════════════════════╗
                        🧝 Elfos 🧝
╚══════════════════════════════════════════════════════════╝
...
~ El Árbol Milenario, dominio de los elfos, es custodiado aún por ellos mismos y su casa Lorien es representada por sus guerreros más hábiles en el Reino de MissiaM.

⭐ A través de los milenios, la raza ha dominado el control total del Maná, brindándoles capacidades extras.
...
⭐ Los enanos tienen una excepcional capacidad para visualizar los mejores materiales y objetos.
